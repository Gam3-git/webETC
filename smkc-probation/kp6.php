...
<div class="row pt-4 bg-dark">
        ...
        <p class="h5 text-warning">บันทึกหนังสือ ( ค.ป.6 ) --- ( ค.ป.ย.5 )</p>
                    ...
                    <button class="btn btn-light" name="editcaseBtn" id="editcaseBtn">แก้ไข ค.ป.6 </button>
...
<div class="form-group row mt-2">
        ...
        <div class="col-4">
            <label for="obt7"><br>วันที่คำสั่งศาล(แจ้งงด)</label> 
            <input class="form-control" type="text" id="obt6" name="obt6"  value=""> 
        </div>
        <div class="col-4">            
            <label for="obt11">จำนวนสำเนารายงานกระบวนพิจารณา/<br>คำสั่งงดการสืบเสาะและพินิจ  (แผ่น)</label> 
        ...
        <div class="col-4">
            <label for="obt12">เลขหนังสือที่อ้างถึง(ใส่แค่ตัวเลข)</label>
            <input class="form-control" type="number" id="obt11" name="obt11"  value=""> 
        </div>
        <div class="col-4">
            <label for="obt13">วันที่หนังสือที่อ้างถึง</label>
